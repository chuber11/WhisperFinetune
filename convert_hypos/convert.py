...
def run_llm(utterance, model="gpt-3.5-turbo", max_tokens=512, number=0):
...
if __name__ == "__main__":
    ...
    #files = "../hypos/hypo_openai_whisper-large-v2_beam4.*.txt"
    files = "../hypos/hypo_openai_whisper-large-v2_beam4.*.human.txt"
    ...
    for file in glob(files):
        ...
        for i,line in enumerate(lines):
            ...
            response = run_llm(hypo, number=number)
