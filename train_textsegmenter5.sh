...
python -u train_mt.py --model_path ./saves/model_$model_name \
    --segfiles hypos_whisper_cv/step1_id/cv_filtered.*.train.seg.aligned \
    --segfiles_dev hypos_whisper_cv/step1_id/cv_filtered.*.dev.seg.aligned \
    --eval_steps 500 \
    | tee $logfile
