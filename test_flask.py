...
for line in open(segfile):
    ...
    res = requests.post("http://192.168.0.72:4999/asr/infer/en,en", files={"pcm_s16le":wav_, "prefix": "My professor is called Alexander Waibel, and I hope the name is recognised correctly. For sure let’t do another test. Alexander Waibel is his name.", "memory":json.dumps(["Christian","Huber","Waibel"])})
