...
#python decode_asr.py --segfiles data_filtered_test/${testset}_memory.$language.test.seg.aligned --model_path $model --model_name $model --use_memory --memory_file $memory --language $language2 --hypo_file hypos_memory/$model2.$language.$memory2.$distractors.$addscore.oracle.hyp --no_write_at_end --memory_num_distractors $distractors --batch_size 1 --force_exact_memory $addscore
