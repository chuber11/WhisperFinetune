...
model_name="${2:-newwords18_2_enes3_3}"
...
python -u train.py --model_path ./saves/model_$model_name \
    --segfiles data_cs2/*.train.seg.aligned data_cs/*.train.seg.aligned data_cs3/*.train.seg.aligned \
    --segfiles_dev data_cs2/*.dev.seg.aligned data_cs/*.dev.seg.aligned data_cs3/*.dev.seg.aligned \
